...
%csvfile='C:\Users\华为\Desktop\毕业论文\A5仿真数据\Sexp-4236.csv'; startRound=4001;
function [a_tial Yret3  YretAvg Mean5 ]=read_5angl_for_stagy(csvfile, startRound)  % (filename, 4001)  
